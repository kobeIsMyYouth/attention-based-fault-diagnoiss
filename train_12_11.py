...
def test(epoch):
    ...
    if test_acc > best_test_acc:
        ...
        torch.save(state, os.path.join('./checkpoints/TE chemical process/res_12_11', cfg.model + '-' + str(epoch) + '.t7'))
        best_test_acc = test_acc
        best_test_acc_epoch = epoch
        print('更新完成')
...
if __name__ == "__main__":
    ...
    np.savetxt("./results/TE chemical process/res_12_11/trainlosss.txt", trainlosss)
    np.savetxt("./results/TE chemical process/res_12_11/train_accs.txt", train_accs)
    np.savetxt("./results/TE chemical process/res_12_11/testlosss.txt", testlosss)
    np.savetxt("./results/TE chemical process/res_12_11/test_accs.txt", test_accs)
