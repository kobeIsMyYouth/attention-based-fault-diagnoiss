...
import os
import dataLoader
from model import CNN_LSTM_0_new
import torch
...
parser.add_argument("--bs", default=200, type=int, help="batchsize")
...
parser.add_argument("--dr", default="./data/TE", type=str, help="数据所在的根路径")
parser.add_argument("--ep", default=100, type=int, help="训练的总轮数")
parser.add_argument('--re', default=True, help='是否从checkpoint处开始训练')
parser.add_argument("--ckpt", default="./checkpoints/TE chemical process/res_12_0/CNN-LSTM-96.t7", help="checkpoint的地址")
...
net = CNN_LSTM_0_new.CNN_LSTM(cfg.ts)
