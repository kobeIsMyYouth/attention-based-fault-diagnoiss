...
import os
import dataLoader
from model import CNN_LSTM_11_WTB
import torch
...
net = CNN_LSTM_11_WTB.CNN_LSTM(cfg.ts)
...
def test(epoch):
    ...
    if test_acc > best_test_acc:
        ...
        torch.save(state, os.path.join('./checkpoints/WTB_icing/res_26_11', cfg.model + '-' + str(epoch) + '.t7'))
        best_test_acc = test_acc
        best_test_acc_epoch = epoch
        print('更新完成')
...
if __name__ == "__main__":
    ...
    np.savetxt("./results/WTB_icing/res_26_11/trainlosss.txt", trainlosss)
    np.savetxt("./results/WTB_icing/res_26_11/train_accs.txt", train_accs)
    np.savetxt("./results/WTB_icing/res_26_11/testlosss.txt", testlosss)
    np.savetxt("./results/WTB_icing/res_26_11/test_accs.txt", test_accs)
